...
contract Ownable {
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        address currenOwner = _owner;
        _owner = newOwner;
        emit ownerShipTransfered(currenOwner, newOwner);
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != ownerOf(tokenId), "Token is already owned by owner - to");
...
contract ERC721MintableComplete is ERC721Metadata("MintableTokens", "MTOKENS", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
