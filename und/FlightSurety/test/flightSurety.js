...
contract('Flight Surety Tests', async (accounts) => {
  ...
  it("Fund airline (self)", async () => {
    ...
    b = await config.flightSuretyApp.buyInsurance("IND1234", {from: accounts[1], value: 99});

    config.flightSuretyData.insuredAmount.call("IND1234", accounts[1]).then((balance) => {
